  ...
  render() {
    return (
      <BrowserRouter>
        ...
        <div>
        <h1 style={{margin: '0 auto'}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="green" class="bi bi-flower1" viewBox="0 0 16 16">
        ...
        Plant<span style={{color: 'green'}}>Shlf</span></h1>
          ...
          <div className="content">
             ...
             <Route exact path="/plants/:commonName" component={PlantDetail}/>
             <Route exact path="/update/:commonName" component={UpdatePlant}/>
             <Route exact path="/delete/:commonName" component={DeletePlant}/>
             <Route exact path="/shlf" component={PlantShlf}/>
          </div>
        </div>
        <footer> 
            <ul className="footer">
...
//              <Route path="/users/update/:plant" component={UpdatePlant}/>
//              <Route path="/users/delete/:plant" component={DeletePlant}/>
//           </div>
//         </div>
//         <footer> 
//             <ul className="footer">
